...
type ChatBotProps = {
  role: "Farmer" | "Seller" | "Transformateur" | "consommateur";
  conversationId: string | null;
};

const ChatBott: React.FC<ChatBotProps> = ({ role, conversationId: propConversationId }) => {
  ...
  const roleColors = {
    Farmer: { primary: "bg-green-600", hover: "hover:bg-green-700", userBubble: "bg-green-100", botBubble: "bg-white" },
    Seller: { primary: "bg-yellow-600", hover: "hover:bg-yellow-700", userBubble: "bg-yellow-100", botBubble: "bg-white" },
    Transformateur: { primary: "bg-purple-600", hover: "hover:bg-purple-700", userBubble: "bg-purple-100", botBubble: "bg-white" },
    consommateur: { primary: "bg-blue-600", hover: "hover:bg-blue-700", userBubble: "bg-blue-100", botBubble: "bg-white" },
  };
  const colors = roleColors[role] || roleColors.consommateur;
